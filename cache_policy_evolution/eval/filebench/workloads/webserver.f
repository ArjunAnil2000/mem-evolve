# FileBench webserver workload
# Emulates a web server: read files, append to log
...
set $nthreads=100
set $iosize=1048576
set $meanappendsize=8192

define fileset name=bigfileset,path=$dir,size=$filesize,entries=$nfiles,dirwidth=$meandirwidth,prealloc=100
define fileset name=logfiles,path=$dir,size=8192,entries=1,dirwidth=$meandirwidth,prealloc
